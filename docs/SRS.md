...
- المتصفح يدعم WebSocket و Canvas/SVG و ES2020.
...
تُستخدم القالب التالي لكل حالة استخدام:
...
**UC-22 — Assign Lab to Student/Class** — اختيار طلّاب أو صف وإسناد lab مع تاريخ تسليم.
...
- **FR-041** يجب أن يلتزم كل log بالمخطّط: `{ts, src_device, src_ip, src_mac, type, severity, payload}`. *(traces: UC-14)*
